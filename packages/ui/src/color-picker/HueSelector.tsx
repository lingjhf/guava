...
export interface GHueSelectorProps {
  vertical: boolean
  color: Color
  size: Size
  sliderSize: Size
...
export const GHueSelector = (props: Partial<GHueSelectorProps>) => {
  const defaultProps = mergeProps<[GHueSelectorProps, ...Partial<GHueSelectorProps>[]]>(
    {
      color: Color().hsv(),
      vertical: false,
